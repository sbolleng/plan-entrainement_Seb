function showSection(id, btn) {
  ...
  // ===== Stats · graphiques de progression (données Strava, calculées le 28/08/2026) =====
  ...
  const statsMonthly = [
    ...
    { label: 'Août', distanceKm: 99.4,  dplusM: 1367, paceSecPerKm: null, cadenceSpm: null, hrBpm: null, effBeats: null, dpk: 13.7 },
  ];
