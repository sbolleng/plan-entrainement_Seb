function showSection(id, btn) {
  ...
  // ===== Stats · graphiques de progression (données Strava, calculées le 24/08/2026) =====
  ...
  const statsMonthly = [
    ...
    { label: 'Août', distanceKm: 90.8,  dplusM: 1360, paceSecPerKm: null, cadenceSpm: null, hrBpm: null, effBeats: null, dpk: 15.0 },
  ];
