function showSection(id, btn) {
  ...
  // ===== Stats · graphiques de progression (données Strava, calculées le 05/09/2026) =====
  ...
  const statsMonthly = [
    ...
    // cadence et efficience restent à null : seulement 2 sorties très différentes
    // (34 min à 4:55/km, puis 74 min avec D+) — pas encore assez comparables pour
    // une moyenne mensuelle qui aurait un sens. FC non disponible sur ces séances.
    { label: 'Sept', distanceKm: 20.1,  dplusM: 133,  paceSecPerKm: null, cadenceSpm: null, hrBpm: null, effBeats: null, dpk: 6.6 },
  ];
