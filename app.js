function showSection(id, btn) {
  ...
  // ===== Stats · graphiques de progression (données Strava, calculées le 27/08/2026) =====
  ...
  const statsMonthly = [
    ...
    { label: 'Août', distanceKm: 97.1,  dplusM: 1367, paceSecPerKm: null, cadenceSpm: null, hrBpm: null, effBeats: null, dpk: 14.1 },
  ];
