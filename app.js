function showSection(id, btn) {
  ...
  // ===== Stats · graphiques de progression (données Strava, calculées le 09/08/2026) =====
  ...
  const statsMonthly = [
    ...
    { label: 'Août', distanceKm: 25.8,  dplusM: 585,  paceSecPerKm: null, cadenceSpm: null, hrBpm: null, effBeats: null, dpk: 22.7 },
  ];
